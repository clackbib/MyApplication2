...
public abstract class PhonecallReceiver extends BroadcastReceiver
{
    ...
    public void onCallStateChanged(Context context, int state, String number) throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        if(lastState == state){
