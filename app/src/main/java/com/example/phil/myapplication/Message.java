...
public class Message extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        blacklist = (ListView) view.findViewById(R.id.messageListView);
        blacklist.setLongClickable(true);

        CustomAdapter adapterNew = ((MainActiv)getActivity()).getMessageAdapter();
        //ArrayAdapter<String> adapter = ((MainActiv)getActivity()).getMessageAdapter();

        blacklist.setAdapter(adapterNew);
        return view;
    }
